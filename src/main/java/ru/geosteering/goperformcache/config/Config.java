package ru.geosteering.goperformcache.config;
...
public class Config {
    ...
    public static final int HISTORY_REQUEST_THREADS;
    ...
    static {
        ...
        HISTORY_REQUEST_THREADS = Integer.parseInt(properties.getProperty("history-request-threads", "2"));
